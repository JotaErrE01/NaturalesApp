    ...
    <div className="w-full">
      ...
      >
        ...
        <div className="flex lg:flex-row flex-col gap-5">
          <img
            className="w-4/5 lg:w-[40%] mx-auto mt-5 rounded"
          ...
          <img
            ...
            src="https://www.eluniverso.com/resizer/QdMd8jeWSLnhen0Ex94P99PfXH4=/1157x670/smart/filters:quality(70)/cloudfront-us-east-1.images.arcpublishing.com/eluniverso/AHEUL2SO4JTQY4LNL4L3LHV2S4.jpg"
            alt="Evolucion Estelar" 
          />
        </div>
      </div>
